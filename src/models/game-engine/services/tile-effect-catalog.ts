...
function bySlotLinear(
  ...
  return {
    expressionPerSlot: (slot) => {
      const totalDice = baseDice + extraDicePerSlotAbove * Math.max(0, slot - baseSlot);
...
export const TILE_EFFECT_CATALOG: Record<TileEffectKind, TileEffectDefinition> = {
  ...
  grease: {
    ...
    triggers: [
      ...
      { kind: 'on-enter', save: { ability: 'dex', onFailCondition: 'prone' } },
    ],
    tactical: {
    ...
    narrativeDescriptor: 'Graxa escorregadia cobre o chão; pés deslizam sem firmeza.',
  },
  ...
  web: {
    ...
    sourceConcentration: true,
    triggers: [
      { kind: 'on-cast', save: { ability: 'dex', onFailCondition: 'restrained' } },
      { kind: 'on-enter', save: { ability: 'dex', onFailCondition: 'restrained' } },
    ],
    tactical: {
    ...
    narrativeDescriptor: 'Teias densas se estendem entre o chão e o teto, agarrando quem entra.',
  },
  ...
  'spike-growth': {
    ...
    sourceConcentration: true,
    triggers: [
      { kind: 'on-move-through', damagePerCell: fixedDamage(2, 4, 'piercing') },
    ],
    tactical: {
      tags: ['damage', 'difficult-terrain', 'denial', 'forced-movement-amplifier'],
      tacticalValue: 8,
      beneficiaryFaction: 'caster',
      creatureAffinity: { low: ['flying'] },
    },
    narrativeDescriptor: 'Espinhos curvos brotam do solo, ferindo quem se move sobre eles.',
  },
  ...
  'wall-of-fire': {
    ...
    narrativeDescriptor: 'Parede de chamas ruge a 6 metros de altura; o calor pulsa do lado escolhido.',
  },
  ...
  'cloud-of-daggers': {
    ...
    triggers: [
      ...
      { kind: 'on-start-turn-in', damage: bySlotLinear(2, 4, 'slashing', 4, 2) },
    ],
    tactical: {
    ...
    narrativeDescriptor: 'Lâminas espectrais giram em círculo, cortando o ar com precisão letal.',
  },
  ...
  'sleet-storm': {
    ...
    tactical: {
      tags: ['control', 'prone', 'difficult-terrain', 'concentration-break', 'vision-block'],
      tacticalValue: 9,
      beneficiaryFaction: 'caster',
      creatureAffinity: { low: ['concentration-dependent'] },
    },
    narrativeDescriptor: 'Granizo cortante e gelo escorregadio caem em redemoinho dentro do cilindro.',
  },
  ...
  'spirit-guardians': {
    ...
    narrativeDescriptor: 'Guardiões espectrais orbitam o conjurador, cintilando em luz divina.',
  },
};
