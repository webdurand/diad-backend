...
export class RestSessionEntity {
  ...
  @Column({ name: 'interruption_reason', type: 'varchar', length: 40, nullable: true })
  interruptionReason?: string;

  @Column({ name: 'event_triggered', type: 'varchar', length: 40, nullable: true })
  ...
  @Column({ name: 'features_restored', type: 'text', array: true, default: () => "ARRAY[]::TEXT[]" })
