...
const PRESETS: PresetPayload[] = [
  {
    ...
    forbiddenTropes: ['deus-ex-machina', 'amnesia-barata', 'NPC-plot-armor-sem-motivo'],
    constraints: [
  ...
  },
  {
    ...
    emotionalTriggers: {
      ...
      onVictoryClimax: 'vitória com perda visível — sangue no manto, fumaça no ar',
    ...
    forbiddenTropes: ['final-feliz-sem-custo', 'deus-ex-machina', 'romance-de-conveniência'],
    constraints: [
  ...
  },
  {
    ...
    forbiddenTropes: ['jumpscare-gratuito', 'vilão-genérico', 'explicação-lore-dump'],
    constraints: [
  ...
  },
  {
    ...
    emotionalTriggers: {
      ...
      onVictoryClimax: 'celebração ruidosa; improviso que funciona contra todas as chances',
      onBetrayal: 'dramático, mas com um toque absurdo (o vilão quebra o bigode)',
      onDiscovery: 'olhos brilhantes; todo mundo fala junto por um segundo',
      onEpilogue: 'tavernas cheias; brindes; crédito ambíguo',
    },
    forbiddenTropes: ['humor-de-piada-interna-moderna', 'quebra-de-tom-gratuita'],
    constraints: [
      'nunca quebre 4th wall',
...
export class SeedVoiceProfilePresets1778080000000
