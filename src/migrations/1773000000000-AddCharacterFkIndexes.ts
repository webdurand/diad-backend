...
export class AddCharacterFkIndexes1773000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_character_proficiencies_character_id" ON "character_proficiencies" ("character_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_character_magic_items_character_id" ON "character_magic_items" ("character_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_character_level_ups_character_id" ON "character_level_ups" ("character_id")`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_character_level_ups_character_id"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_character_magic_items_character_id"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_character_proficiencies_character_id"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_character_equipment_character_id"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_character_spells_character_id"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_character_skills_character_id"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_character_ability_scores_character_id"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_character_classes_character_id"`,
    );
  }
}
