...
export class SquashNovosAjustesSrd5211772000004000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "characters" DROP CONSTRAINT IF EXISTS "FK_characters_user"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "classes" ADD COLUMN IF NOT EXISTS "weapon_mastery_count" integer NOT NULL DEFAULT 0`,
    );
    await queryRunner.query(
      `ALTER TABLE "classes" ADD COLUMN IF NOT EXISTS "weapon_mastery_restriction" text`,
    );
    await queryRunner.query(
      `ALTER TABLE "classes" ADD COLUMN IF NOT EXISTS "cantrips_known" integer NOT NULL DEFAULT 0`,
    );
    await queryRunner.query(
      `ALTER TABLE "classes" ADD COLUMN IF NOT EXISTS "spells_prepared_count" integer NOT NULL DEFAULT 0`,
    );
    await queryRunner.query(
      `ALTER TABLE "classes" ADD COLUMN IF NOT EXISTS "spellbook_count" integer NOT NULL DEFAULT 0`,
    );
    await queryRunner.query(
      `ALTER TABLE "classes" ADD COLUMN IF NOT EXISTS "class_features_level_1" jsonb`,
    );
    await queryRunner.query(
      `ALTER TABLE "backgrounds" ADD COLUMN IF NOT EXISTS "ability_scores" jsonb`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "eldritch_invocations" DROP CONSTRAINT IF EXISTS "FK_7d38e84bbd394c731a996cedc7b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "characters" DROP CONSTRAINT IF EXISTS "FK_c6e648aeaab79e4213def02aba8"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "backgrounds" DROP COLUMN IF EXISTS "ability_scores"`,
    );
    await queryRunner.query(
      `ALTER TABLE "classes" DROP COLUMN IF EXISTS "class_features_level_1"`,
    );
    await queryRunner.query(
      `ALTER TABLE "classes" DROP COLUMN IF EXISTS "spellbook_count"`,
    );
    await queryRunner.query(
      `ALTER TABLE "classes" DROP COLUMN IF EXISTS "spells_prepared_count"`,
    );
    await queryRunner.query(
      `ALTER TABLE "classes" DROP COLUMN IF EXISTS "cantrips_known"`,
    );
    await queryRunner.query(
      `ALTER TABLE "classes" DROP COLUMN IF EXISTS "weapon_mastery_restriction"`,
    );
    await queryRunner.query(
      `ALTER TABLE "classes" DROP COLUMN IF EXISTS "weapon_mastery_count"`,
    );
